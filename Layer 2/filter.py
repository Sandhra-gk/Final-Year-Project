...
def process(features, isMemory, isAF):
    ...
    file_path = "/home/tejaswini/Desktop/pypy/report.json"
    result = [file_path]
    dataframes = list()
...
if __name__ == "__main__":
    features = ['procmemory', 'file', 'urls', 'proc_pid', 'procm_extracted', 'name', 'type', 'ext_urls', 'path', 'extracted', 'info', 'program', 'virustotal', 'vir_summary', 'positives', 'network', 'udp', 'dns_servers', 'tcp', 'mitm', 'hosts', 'domains', 'dead_hosts', 'dns', 'request', 'signatures', 'families', 'description', 'sign_name', 'marks', 'call', 'category', 'sign_stacktrace', 'api', 'arguments', 'static', 'imported_dll_count', 'pe_imports', 'dll', 'pe_resources', 'pe_res_name', 'filetype', 'pe_sections', 'pe_sec_name', 'entropy', 'behavior', 'apistats', 'processes', 'process_path', 'pid', 'process_name', 'beh_command_line', 'ppid', 'processtree', 'tree_process_name', 'tree_command_line', 'children', 'summary', 'file_created', 'dll_loaded', 'regkey_opened', 'wmi_query', 'command_line', 'file_read', 'regkey_read', 'directory_enumerated', 'regkey_written', 'debug', 'action', 'errors', 'log']
    ismem=True
    isAF=False
    process(features,ismem,isAF)
